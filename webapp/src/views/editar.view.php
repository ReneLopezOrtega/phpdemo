      ...
      <form action="editar.php" method="post">
        ...
        <div class="card-body">
          ...
          <div class="form-row mb-2">
            <div class="col">
              <input type="text" name="nombre" class="form-control" placeholder="Nombre" autofocus required value="<?= $nombre ?>">
            </div>
            <div class="col">
              <input type="text" name="apellidos" class="form-control" placeholder="Apellido" required value="<?= $apellidos ?>">
            </div>
          </div>
